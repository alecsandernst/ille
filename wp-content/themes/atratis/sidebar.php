<aside>
    ...
    <div class="navegacao">
        ...
        <ul>
            ...
            $blog_category_id = get_cat_ID('Blog'); // Substitua 'Blog' pelo nome exato da categoria "Blog" se for diferente
