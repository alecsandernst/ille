...
<section class="sessaoTextoImagemFull <?php echo $classe; ?> <?php echo $parallax; ?> " style="<?php echo $geraisCSS; ?>" <?php echo $animacao; ?>>

    
    <div class="container">
        <div class="row align-items-center row-full" style="flex-direction: <?php echo $direction; ?>">
            
            <div class="<?php echo $posicao == 0 ? 'img-fluid-left' : 'img-fluid-right'?>"  >
                <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" <?php echo $animacaoImagem; ?>>
            </div>

            <div class="col-lg-6 <?php echo $posicao == 0 ? 'padding-personalizado-left' : 'padding-personalizado-rigth'?>" <?php echo $animacaoConteudo; ?> >
                    <?php if($subtitulo){
                        ?>
