                ...
                <div class="grid-beneficios">
                    <?php foreach($listaBeneficios as $item){
                        ...
                        <?php
                            ...
                            <div class="item-beneficio bg-verde">
