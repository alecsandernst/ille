...
$background_section = get_sub_field('bg_img');
...
<section class="sessaoPlanosBanner <?php echo $classe; ?> <?php echo $parallax; ?> " style="<?php echo $geraisCSS; ?>" <?php echo $animacao; ?> data-aos='fade-up' data-aos-duration='1000'>

    
    <div class="container">
        <div class=" ">
            <div class="row content-bg align-items-center" style="flex-direction: <?php echo $direction; ?>;background-image: url('<?php echo $background_section['url']; ?>');background-repeat: no-repeat;
                background-size: container;">
                <div class="col-lg-7"  >
                    <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" <?php echo $animacaoImagem; ?>>
                </div>
                <div class="col-lg-5" <?php echo $animacaoConteudo; ?>>
                        <?php if($subtitulo){
                            ?>
